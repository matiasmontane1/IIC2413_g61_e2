...
$tablas_iniciales = array(
    'Facultades' => 'NombreFacultad VARCHAR(255)',
    ...
    'Planes_facu' => 'ConexionID SERIAL PRIMARY KEY, CodigoPlan VARCHAR(255) REFERENCES Planes(CodigoPlan), FacultadID INT REFERENCES facultades(FacultadID)',
    ...
    'Depa_facu' => 'ConexionID INT PRIMARY KEY, NombreFacultad VARCHAR(255) REFERENCES facultades(FacultadID), CodigoDepartamento INT REFERENCES departamentos(CodigoDepartamento)',
    ...
    'Estudiantes' => 'NumeroEstudiante INT PRIMARY KEY, RUN INT REFERENCES personas(RUN), Cohorte CHAR(7), Bloqueo VARCHAR(50), Causal_Bloqueo VARCHAR(255), Ultima_carga CHAR(7), Fecha_logro CHAR(7), Logro VARCHAR(255)',
...
>>>>>>> cf60d9f78d21aa9cb5d0105a8fedc45604592f01
    ...
    'Prerrequisitos' => 'PrerequisitosID SERIAL PRIMARY KEY, Sigla VARCHAR(255) REFERENCES cursos(Sigla), Requisito1 VARCHAR(255), Requisito2 VARCHAR(255)'
);
