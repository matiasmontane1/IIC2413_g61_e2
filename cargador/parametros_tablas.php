...
$path_tablas = array(
    ...
    'Planes_carrera' => '../datos_aceptados/Planes_carrera_gud.csv',
...
$tablas_iniciales = array(
    ...
    'Estudiante_carrera_plan' => 'ConexionID INT PRIMARY KEY, NumeroEstudiante INT REFERENCES Estudiantes(NumeroEstudiante), CodigoPlan VARCHAR(6) REFERENCES Planes(CodigoPlan), NombreCarrera VARCHAR(255) REFERENCES Carreras(NombreCarrera)',
    ...
    'Curso_plan' => 'ConexionID INT PRIMARY KEY, Sigla VARCHAR(255) REFERENCES Cursos(Sigla), CodigoPlan VARCHAR(6) REFERENCES Planes(CodigoPlan)',
