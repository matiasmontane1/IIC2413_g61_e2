...
$path_tablas = array(
    ...
    'Departamentos_facu' => '../datos_aceptados/Departamentos_facu_gud.csv',
    ...
    'Planes_carrera' => '../datos_aceptados/Planes_carreras_gud.csv',
    ...
    'Historial_Academico' => '../datos_aceptados/Notas_gud.csv',
...
$tablas_iniciales = array(
    ...
    'Planes' => 'CodigoPlan VARCHAR(6) PRIMARY KEY, NombrePlan VARCHAR(255), InicioVigencia DATE, Jornada VARCHAR(50), Modalidad VARCHAR(50), Sede VARCHAR(100), Grado VARCHAR(50)',
    'Planes_facu' => 'ConexionID INT PRIMARY KEY, CodigoPlan VARCHAR(6) REFERENCES Planes(CodigoPlan), NombreFacultad VARCHAR(225) REFERENCES Facultades(NombreFacultad)',
    'Planes_carreras' => 'ConexionID INT PRIMARY KEY, NombreCarrera VARCHAR(255) REFERENCES Carreras(NombreCarrera), CodigoPlan VARCHAR(6) REFERENCES Planes(CodigoPlan)',
    ...
    'Estudiantes_carrera_plan' => 'ConexionID INT PRIMARY KEY, NumeroEstudiante INT REFERENCES Estudiantes(NumeroEstudiante), NombreCarrera VARCHAR(255) REFERENCES Carreras(NombreCarrera), CodigoPlan VARCHAR(6) REFERENCES Planes(CodigoPlan)',
    ...
    'Cursos_plan' => 'ConexionID INT PRIMARY KEY, CodigoPlan VARCHAR(6) REFERENCES Planes(CodigoPlan), Sigla VARCHAR(255) REFERENCES Cursos(Sigla)',
